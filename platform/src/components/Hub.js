  ...
  },
  {
    ...
    games: [
      ...
      },
      {
        id: 'spiderman',
        emoji: '🕷️🕸️',
        nameKey: 'spiderManName',
        descKey: 'spiderManDesc',
        bg: 'linear-gradient(145deg, #8b0000, #cc2222)',
  ...
  },
  {
    ...
    games: [
      ...
      },
      {
        id: 'picturepuzzle',
        emoji: '🧩',
        nameKey: 'picturePuzzleName',
        descKey: 'picturePuzzleDesc',
        bg: 'linear-gradient(145deg, #e65100, #ffb74d)',
        glow: 'rgba(230,81,0,0.4)',
      },
      {
        id: 'bubblepop',
        emoji: '🫧',
        nameKey: 'bubblePopName',
        descKey: 'bubblePopDesc',
